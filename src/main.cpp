...
{
    int64 nSubsidy = 100 * COIN; //no of coins per block awarded
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Credit: 0.35 days retarget
static const int64 nTargetSpacing = 30; // Credit: 30 second blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8847d4549c8688b953d85c2db3a8f10dae5c259b1ca3f7c8c909c59707556f18");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "London Mayor Boris Johnson offers to enter talks with the RMT union if it calls off the planned Tube strikes";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xf3e82be68b849209bf778918e7d4c45400994122b59791293c0142995334778e"));
